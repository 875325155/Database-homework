...
# Form implementation generated from reading ui file 'window_add_goods_output_add.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_Cno.setGeometry(QtCore.QRect(70, 110, 72, 15))
        self.label_Cno.setObjectName("label_Cno")
        self.label_Eno = QtWidgets.QLabel(Dialog)
        self.label_Eno.setGeometry(QtCore.QRect(70, 160, 72, 15))
        self.label_Eno.setObjectName("label_Eno")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(190, 300, 93, 28))
        self.pushButton.setObjectName("pushButton")
        self.label_Eno_2 = QtWidgets.QLabel(Dialog)
        self.label_Eno_2.setGeometry(QtCore.QRect(70, 220, 72, 15))
